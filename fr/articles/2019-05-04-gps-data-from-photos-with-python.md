---
title: Données GPS de photos avec Python
alt: Données GPS de <br> photos avec *Python*
categories: Python
---
...
On l'installe facilement, sous Python3, avec le *fork* [Pillow](https://pillow.readthedocs.io). On utilise la commande suivante{{% marginalia %}}selon votre configuration, `pip3` peut être directement accessible avec `pip`{{% /marginalia %}} :
