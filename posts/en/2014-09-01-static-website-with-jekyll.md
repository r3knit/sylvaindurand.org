...
- [creating a multilingual website]({{ site.data.translations[page.lang].base }}/making-jekyll-multilingual/) as it has been done here;
- [website delivery with *CloudFront*]({{ site.data.translations[page.lang].base }}/website-delivery-with-cloudfront/) in order to get excellent performances and handle huge increases in workload;
- [hosting *Jekyll* on GitHub]({{ site.data.translations[page.lang].base }}/using-github-to-serve-jekyll/) in order to edit your website online and generate it on the fly.
