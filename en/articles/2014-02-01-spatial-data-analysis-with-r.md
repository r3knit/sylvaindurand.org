...
{{% large %}}
[![France blank map](/img/carto/france.jpg)](/pdf/carto/france.pdf)
{{% /large %}}
...
{{% large %}}
[![Population density in France](/img/carto/density.jpg)](/pdf/carto/density.pdf)
{{% /large %}}

## Visualizing an external data : incomes
The main value is to plot data provided by external files. We will plot the median taxable income per consumption unit ([provided by INSEE](https://www.insee.fr/)).
...
{{% large %}}
[![Median taxable income per consumption unit in France in 2010](/img/carto/incomes.jpg)](/pdf/carto/incomes.pdf)
{{% /large %}}
...
{{% large %}}
[![French roads network](/img/carto/routes.jpg)](/pdf/carto/routes.pdf)
{{% /large %}}
...
{{% large %}}
[![Human Development Index (HDI) in 2012](/img/carto/hdi.jpg)](/pdf/carto/hdi.pdf)
{{% /large %}}
...
{{% large %}}
[![Most populated cities in the world](/img/carto/villes.jpg)](/pdf/carto/villes.pdf)
{{% /large %}}
...
{{% large %}}
[![World map (Winkel Tripel projection)](/img/carto/urbain.jpg)](/pdf/carto/urbain.pdf)
{{% /large %}}
